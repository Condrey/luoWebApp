...
export async function updatePetition(
  ...
  try {
    ...
    console.error(e);
    return {
      message: "Database Error: Failed to Update Petition.",
      type: "error",
    };
  }
  return {
...
export async function deletePetition(
  ...
  try {
    ...
    console.error(e);
    return {
      message: "Database Error: Failed to Delete Petition.",
      type: "error",
    };
  }
}
