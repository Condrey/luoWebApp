...
import ProgressPetitions, {
  ProgressPetitionSkeleton,
} from "@/components/progressPetitions";
  ...
  return (
    <div>
      ...
      <div className="bg-accent md:px-2 py-12 flex flex-col items-center justify-center w-full gap-12 px-4">
        ...
        <Suspense fallback={<DominantFiguresPetitionsSkeleton />}>
...
export const metadata = {
  title: `Petition`,
  description:
    "Petition signatures to bid for the stadium construction in Lira",
};
