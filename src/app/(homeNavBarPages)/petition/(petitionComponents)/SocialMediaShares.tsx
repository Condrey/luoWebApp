import TweetContainer from "@/app/(homeNavBarPages)/petition/(petitionComponents)/tweet-container";

export default function SocialMediaShares() {
  return (
    <div className="max-w-7xl flex flex-col  gap-6 px-3">
      <span className="text-2xl">
        Share this petition, click these cards to share
      </span>
      <div className="flex flex-col  gap-12">
        {prepopulatedTweets.map((prepopulatedTweet) => {
          ...
          return (
            <div
              key={prepopulatedTweet.ageGroup}
              className="flex flex-col  gap-6"
            >
              <span className="text-2xl font-bold uppercase">
                {prepopulatedTweet.ageGroup}
                <br />
                <span className="text-sm lowercase tracking-wider">
                  Click card to share
                </span>
              </span>

              <div className="grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 max-w-7xl gap-6">
