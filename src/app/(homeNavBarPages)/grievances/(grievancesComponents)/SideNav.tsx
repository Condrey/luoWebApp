...
import OtherNavigationSmallScreen from "@/app/(homeNavBarPages)/grievances/other-navigation-small-screen";
...
export function OtherNavigations() {
  return (
    <>
      <div className="flex flex-col gap-2  justify-between pb-6">
        <span className="text-2xl font-bold flex md:hidden md:pb-3">
          Other Navigation
        </span>
