...
const BannerSection = () => {
  ...
  return (
    <div className="flex flex-col w-full p-2 pb-6 md:p-12 gap-5 md:gap-10 bg-gradient-to-b dark:bg-gradient-to-t from-5% from-accent text-accent-foreground">
      <div className="grid md:grid-cols-2 gap-6 max-w-screen-xl justify-center">
        ...
        <div className="flex items-center justify-center aspect-video   rounded-md  flex-col ">
          <Video
            title={videoCitation}
            audio={false}
            autoPlay={true}
