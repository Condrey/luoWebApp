  ...
  return (
    <div className="flex px-4 flex-col items-center gap-6">
      <div className="max-w-7xl ">
        <div className="text-center gap-6 uppercase  text-4xl md:text-5xl text-primary dark:text-accent break-words  font-black w-auto p-5">
          Sample videos
        </div>
      ...
      <div className="max-w-7xl ">
        ...
        <div className="grid  md:grid-cols-2 lg:grid-cols-3 items-stretch  gap-6">
          {Array.from({ length: 8 }, (_, index) => (
            <Skeleton key={index} className="h-[250px] w-[350px]" />
          ))}
        </div>
      </div>
    </div>
