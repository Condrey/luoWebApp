...
export default function SocialMediaShare({text, url}: SocialMediaShareProps) {
    ...
    const snapchatShareUrl = `https://www.snapchat.com/add/${encodeURIComponent(url)}`;
    ...
    return (
        <div className='flex gap-3 items-center'>
            <Link href={twitterShareUrl} target="_blank" rel="noopener noreferrer">
                <Image src={TwitterIcon} alt="tweet icons" width={size} height={size} className='dark:invert'/>
            </Link>
            ...
            <Link href={linkedinShareUrl} target="_blank" rel="noopener noreferrer">
                <Image src={LinkedinIcon} alt="tweet icons" width={size} height={size} className=''/>
            </Link>
            <Link href={whatsappShareUrl} target="_blank" rel="noopener noreferrer">
                <Image src={WhatsAppIcon} alt="tweet icons" width={size} height={size} className=''/>
            </Link>
            ...
            <Link href={telegramShareUrl} target="_blank" rel="noopener noreferrer">
                <Image src={TelegramIcon} alt="tweet icons" width={size} height={size} className=''/>
            </Link>
