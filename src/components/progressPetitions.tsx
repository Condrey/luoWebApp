  ...
  return (
    <div className="flex flex-col gap-12">
      <div className="flex flex-col gap-4">
        <span>
          Not yet signed? Sign here{" "}
          <ArrowDownIcon className="animate-bounce float-end mx-1" />
        </span>
        <AddPetitionButton />
      </div>

      <div className="flex flex-col gap-4">
        <span className="font-bold tracking-wider">{`Goal for petition(${requiredNumber.toLocaleString()} signatures)`}</span>
...
export function ProgressPetitionSkeleton() {
  return (
    <div className="flex flex-col gap-12">
      <div className="flex flex-col gap-4">
        <span>
          Not yet signed? Sign here <Skeleton className="size-[18px]" />
        </span>
